...
<body background="front/images/bg.png" >
<!--<audio src="http://ombs76e55.bkt.clouddn.com/11.%E5%96%9C%E6%82%A6.mp3" loop="loop"    autoplay="autoplay"/>
</audio>-->
<div>
    <header id="header">
        <nav>
            ...
            <div class="my-info" onmouseover="hiddeewm()" onmouseout="hiddeewm()">
                ...
                <div id="hiddenewm" hidden="true" >
                    <img src="../img2/my-qrcode.jpg" width="200px" height="200px" >
                    <p></p>
                </div>
            </div>
        </nav>
