...
<head>
    ...
    <meta name="keywords" content="星·光 博客管理系统">
    <meta name="description" content="星·光 博客管理系统">
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">星·光 博客管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="">H-ui</a>
                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="javascript:;" onclick="picture_add('添加管理员','picture-add.html')"><i class="Hui-iconfont">&#xe613;</i> 管理员</a></li>
                            <li><a href="javascript:;" onclick="product_add('添加栏目','product-add.html')"><i class="Hui-iconfont">&#xe620;</i> 栏目</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="/admin/article-list" data-title="文章列表" href="javascript:void(0)">文章列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="product-brand.html" data-title="全部栏目" href="javascript:void(0)">全部栏目</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="member-list.html" data-title="会员列表" href="javascript:;">我的信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
